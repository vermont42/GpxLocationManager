...
class PanSegue: UIStoryboardSegue {
    override func perform() {
        ...
        // Unswizzle.
        method_exchangeImplementations(class_getInstanceMethod(UIViewController.classForCoder(), "viewWillAppearNoOp:"), class_getInstanceMethod(destination.classForCoder, #selector(UIViewController.viewWillAppear(_:))))
